...
const (
	ReverseService_GetReverse_FullMethodName = "/reverse.ReverseService/GetReverse"
)
...
func (c *reverseServiceClient) GetReverse(ctx context.Context, in *GetReverseRequest, opts ...grpc.CallOption) (*GetReverseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetReverseResponse)
	err := c.cc.Invoke(ctx, ReverseService_GetReverse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReverseServiceServer) GetReverse(context.Context, *GetReverseRequest) (*GetReverseResponse, error) {
...
func _ReverseService_GetReverse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetReverseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReverseServiceServer).GetReverse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReverseService_GetReverse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverseServiceServer).GetReverse(ctx, req.(*GetReverseRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ReverseService_GetReverse_Handler,
		},
	},
